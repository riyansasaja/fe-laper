                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="">
                                <div class="input-group input-group-sm input-group-outline my-3">
                                    ...
                                    <div class="col">
                                        <input type="file" class="form-control form-control-sm" placeholder="tes">
                                    </div>
                                </div>
                                <div class="input-group input-group-sm input-group-outline my-3">
                                    <div class="col-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#success_modal" class="btn bg-gradient-primary">Simpan</a>
                        </div>
                    </div>
                </div>
            </div>
